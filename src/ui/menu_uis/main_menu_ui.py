...
class Main_Menu_UI:
	def __init__(self) -> None:
		...
		self.m_start_button: Button | None = None
		self.m_load_button: Button | None = None
		self.m_exit_button: Button | None = None
		self.m_buttons: list[Button] = []

		self.create_buttons()

	def create_buttons(self) -> None:
		"""Create buttons based on current save file availability."""
		...
		self.m_buttons = [self.m_start_button, self.m_exit_button]
		if load_button_available:
	...
	def is_start_button_clicked(self) -> bool:
		return self.m_start_button is not None and self.m_start_button.m_is_clicked

	def is_load_button_clicked(self) -> bool:
		return self.m_load_button is not None and self.m_load_button.m_is_clicked

	def is_exit_button_clicked(self) -> bool:
		return self.m_exit_button is not None and self.m_exit_button.m_is_clicked